        ...
        <div class="mb-4">
            ...
            <div class="flex justify-end">
                <a href="{{ route('students.create')}}"
                    class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Create Student</a>
            </div>
        </div>
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                    <form action="{{ route('students.destroy',$student->id) }}" method="POST" onsubmit="return confirm('{{ trans('are You Sure ? ') }}');">
